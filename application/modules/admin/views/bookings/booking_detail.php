                            ...
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <table class="table  invoice-detail-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a title="view service" href="<?= base_url() ?>admin/service-detail/<?= $order['service_id']; ?>"><?= $order['service_name'] ?></a></td>
                                                <td><a title="view vendor" href="<?= base_url() ?>admin/vendor-detail/<?= $order['vendor_id'] ?>"><?= $order['vendor_name'] ?></a></td>
                                                <td><?= date('H:i:s d M,Y', strtotime($order['start_date'] . $order['start_time'])) ?></td>
                                                <td><?= date('H:i:s d M,Y', strtotime($order['end_date'] . $order['end_time'])) ?></td>
