                ...
                <div class="col-lg-8">
                    <div class="panel profile-cover">
                        ...
                        <div class="profile-cover__info">
                            <ul class="nav">
                                <li>
                                    <strong><?= count($order) ?></strong>Order
                                </li>
                                <li>
                                    <strong><?= count($booking) ?></strong>Booking
                                </li>
                                <li>
                                    ...
                                    if ($order) {
                                        foreach ($order as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $value['total'] ?></td>
                                                <td><?= $value['address'] ?></td>
                                                <td><?= $value['status'] == 1 ? '<span class="label label-warning">Order Placed</span>' : ($value['status'] == 2 ? '<span class="label label-info">Dispatched</span>' : ($value['status'] == 3 ? '<span class="label label-info">On The Way</span>' : ($value['status'] == 4 ? '<span class="label label-success">Completed</span>' : ($value['status'] == 5 ? '<span class="label label-danger">Cancelled</span>' : 'N/A' ) ))) ?></td>
                                                <td><a href="<?= base_url() ?>admin/order-detail/<?= $value['order_id'] ?>"><span class="label action-button"><i class="fa fa-eye"></i></span></a></td>
                                            </tr>
                                            <?php
                                        }
                                    }
                ...
                <div class="col-lg-4">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <a class="panel-title" onclick="deleteUser(this, '<?= $user['id']; ?>')" style="float:right;cursor: pointer;">
...
<!--                                    <p>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <th>
                                            <i class="fa fa-calendar"></i>Registered On</th>
