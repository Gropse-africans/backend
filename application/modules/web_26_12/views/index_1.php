    ...
    <div class="swiper-viewport">
        <div id="slideshow0" class="swiper-container">
            <div class="swiper-wrapper">
                <?php foreach($homepage['slider'] as $slider):?>
                            ...
                            <div class="testimonial_inner">
                                <div class="homepage-testimonials-inner products block_content">
                                    ...
                                    <div id="testimonial-carousel" class="products product-carousel">
                                        <?php foreach($homepage['category'] as $category):?>
                                        <div class="slider-item">
                                            <div class="peoplesay-block">
                                                <div class="test-image">
                                                    <div class="left-img">
                                                        <a href="#"><img src="<?=$category['image']?$category['image']:base_url().'assets/web/images/category/category1.png'?>" alt="Women's Fashion"></a>
                                                    </div>
                                                </div>
                                                <div class="test-dec">
                                                    <div class="title">
            ...
            <div class="box bestseller">
                ...
                <div class="box-content">
                    ...
                    <div class="box-product product-carousel" id="bestseller-carousel">
                        <?php foreach($homepage['product'] as $product):?>
                        <div class="slider-item">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="product_hover_block">
                                            <div class="action">
                                                ...
                                                <button class="wishlist" type="button" title="Add to Wish List " onclick="<?php if($this->session->userdata('customer_logged_in')):echo 'addtowishlist('.$product['product_id'].')';else: echo 'checkout()';endif;?>;"><i class="fa fa-heart"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="offer_block">
                <div class="offer_img">
                    ...
                    <div class="offer-wrapper">
                        ...
                        <a class="offer-btn" href="<?php echo base_url(''); ?>">Join Now</a>
                    </div>
                </div>
            </div>
