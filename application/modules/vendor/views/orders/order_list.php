                                ...
                                <table id="bs4-table" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="txt-dark weight-500">$<?= number_format($order['total_amount'],2)?></span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('vendor/order-detail/'.$order['order_id']); ?>"><span class="label action-button"><i class='fa fa-eye'></i></span></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
