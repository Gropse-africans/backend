                            ...
                            <div class=" col-md-6">
                                <div class="card card-shadow card-body mb-4">
                                    <form method="post"  enctype="multipart/form-data">
                                        ...
                                        <input type="text" name="name" required="" class="form-control" placeholder="Category Name" value="<?php if(isset($singleCategory)){ echo $singleCategory['name']; }?>">
                                        <?= form_error('name') ?>
                                        <label class="mt-2">Category Title</label>
                                        <input type="text" name="title" required="" class="form-control" placeholder="Category Title" value="<?php if(isset($singleCategory)){ echo $singleCategory['title']; }?>">
                                        <?= form_error('name') ?>
                                                ...
                                                foreach ($categories as $value) {
                                                   ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <a href="<?= base_url('admin/service-category/'.$value['id']); ?>"><i class="fa fa-edit fa-2x"></i></a>
        ...
        function checkStatus(obj, id) {
            ...
            if (id) {
                $.ajax({
                    ...
                    type: 'post',
                    data: 'method=changeStatus&id=' + id + '&action=' + status + '&type=8',
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (jsonData['error_code'] == "200") {
                                ...
                                window.location.href="<?= base_url(); ?>admin/service-category";
                            } else {
                                alert(jsonData['message']);
                            }
                        }
