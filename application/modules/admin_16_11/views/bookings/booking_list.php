                                ...
                                <table id="bs4-table" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="txt-dark weight-500">$<?=$order['total']?></span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a title="View Detail" href="<?php echo site_url('admin/booking-detail/'.$order['booking_id']); ?>"><span class="label action-button"><i class="fa fa-eye"></i></span></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
