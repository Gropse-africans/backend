...
//        $vendor_id = $this->vendor_data['vendor_id'];
                ...
                if ($returnData) {
                    ...
                    $this->session->set_flashdata('response', '<div class="alert alert-danger"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>Error While adding new update</div>');
