                                            ...
                                            <div class="card-body">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <!--<span class="error text-danger" id="name"></span>-->
                                                        <input type="text" class="form-control validate" placeholder="Enter Advertisement Name" name="name">
                                                        <?= form_error('name') ?>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class=" right-text-label-form" >
                                                    ...
                                                    <div class="form-group row titleeventimage">
                                                        ...
                                                        <div class="col-sm-8 file-upload" >
                                                            ...
                                                            <img id="blah1" style="height:200px;" src="<?php echo base_url(); ?>assets/vendor/common/images/logo/dummy.jpg" alt="your image" />
...
<script type="text/javascript">
    ...
    function validate() {
        var flag = true;
        var formData = $("#Franchisee").find('.validate:input').not(':input[type=button]');
