        ...
        <div class="col-md-12 text-center">
            ...
            <div class="copy_right">
                ...
                <p>
                    ...
                    2019 ©  All Right Reserved by Africans Supermarket
                </p>
...
<script src="<?php echo base_url('assets/vendor/common/js/jquery.dataTables.min.js'); ?>"></script>

<script src="<?php echo base_url('assets/vendor/common/js/dataTables.bootstrap4.min.js'); ?>"></script>

<script src="<?php echo base_url('assets/vendor/common/js/chart.js'); ?>"></script>

<script src="<?php echo base_url('assets/vendor/common/js/jquery.dcjqaccordion.2.7.js'); ?>"></script>

<script src="<?php echo base_url('assets/vendor/common/js/moment.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/vendor/common/js/fullcalendar.js'); ?>"></script>
<script src="<?php echo base_url('assets/vendor/common/js/calendar-list-init.js'); ?>"></script>
