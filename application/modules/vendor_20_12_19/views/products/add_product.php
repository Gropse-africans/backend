                                ...
                                <div class="row" >
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control validate" placeholder="Discount" min="0" value="0" max="100" name="discount">
                                            <?= form_error('discount') ?>
                                        </div>
                                ...
                                <div class=" right-text-label-form" >
                                    ...
                                    <div class="form-group row titleeventimage">
                                        ...
                                        <div class="col-sm-3 file-upload">
                                            ...
                                            <img id="blah2" src="<?php echo base_url(); ?>assets/vendor/common/images/logo/dummy.jpg" alt="your image" />

                                            <label for="upload2" class="file-upload__label">Upload Image 2</label>

                                            <input id="upload2" accept=".jpg,.png,.jpeg" class="file-upload__input" type="file" name="file_upload[]" onchange="readURL(this, 2);">

                                        </div>

                                        <div class="col-sm-3 file-upload">

                                            <img id="blah3" src="<?php echo base_url(); ?>assets/vendor/common/images/logo/dummy.jpg" alt="your image" />
                                            <label for="upload3" class="file-upload__label">Upload Image 3</label>

                                            <input id="upload3" class="file-upload__input" type="file" name="file_upload[]" accept=".jpg,.png,.jpeg" onchange="readURL(this, 3);">

                                        </div>

                                        <div class="col-sm-3 file-upload">

                                            <img id="blah4" src="<?php echo base_url(); ?>assets/vendor/common/images/logo/dummy.jpg" alt="your image" />

                                            <label for="upload4" class="file-upload__label">Upload Image 4</label>

                                            <input id="upload4" class="file-upload__input" type="file" name="file_upload[]" accept=".jpg,.png,.jpeg" onchange="readURL(this, 4);">
...
//                        console.log(value['title']);
                        ...
                        html += '<select name="attribute_value_' + value['id'] + '" class="form-control '+(value['is_required'] == 1?"validate":"")+'" id="attribute_name">';
                        var arrtVal = '';
                        arrtVal+='<option value="" selected>Select ' + value['title'] + '</option>';
...
//                    console.log(html);
                ...
                if (jsonData['error_code'] == "200") {
                    ...
                    $(jsonData['data']['getcategorySpecification']).each(function (specIndex, specValue) {
                        ...
                        htmlSpec += '<label for="name">' + specValue['title'] + '</label> <span class="error text-danger" id="specification_value_' + specValue['id'] + '"></span><br>';
                        htmlSpec += '<input type="hidden" name="specifications[]" value="' + specValue['id'] + '">';
                        htmlSpec += '<input type="text" placeholder="Enter Specification Name" name="specification_value_' + specValue['id'] + '" class="form-control '+(specValue['is_required'] == 1?"validate":"")+'" id="attributeSpec_name">';
                        // var arrSpecVal='';
