                        ...
                        <div class="col-lg-8"  id="detailDive">
                            <div class="panel profile-cover">
                                ...
                                <div class="profile-cover__info">
                                    <ul class="nav">
                                        <li>
                                            <strong><?=$product_count;?></strong>Produt
                                        </li>
                                        <li>
                                            <strong>0</strong>Order
                                        </li>
                                        <li>
                                            <strong>$0</strong>Sale
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php }?></td>
                                                    <td><a href="http://gropse.com/gropse.com/design/africanssupermarket.com/admin/product-detail"><span class="label action-button"><i class="fa fa-eye"></i></span></a></td>
                                                </tr>
                                                <?php $count++;
                                                        endforeach;
                                                   }
